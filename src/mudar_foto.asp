...
<table border="0" cellpadding="3" cellspacing="0">
	<% if fotoRes("anonima") <> 0 then %>
		<tr>
			...
			<td><select name="anonima">
				...
				<option <% if fotoRes("anonima") = 1 then %>selected<% end if %> value="1">Foto an�nima por uma semana, mas aparece na minha galeria pessoal</option>
				<option <% if fotoRes("anonima") = 2 then %>selected<% end if %> value="2">Completamente an�nima por uma semana, s� eu a vejo na minha galeria</option>
			</select><br>
	...
	<tr><td><font size="-1" color="#FFCC66" face="arial"><b>ILUMINA��O: </b></font></td><td><input maxlength="255" value="<% =Aspas2Quot(fotoRes("flash")) %>" size="40" type="Text" name="flash"></td></tr>
	<tr><td><br></td><td></td></tr>	
