...
%>
	...
	<tr><td>
		...
		<% if not fotoRes.eof then %>
			<font size="-1" color="#FFCC66" face="arial">&nbsp;&nbsp;Coment�rios a fotos suas, por moderar:</font>
		...
		<% if not numComentEsteAutorRes.eof then %>
			&nbsp;&nbsp;<a href="comentarios_autor.asp?id=<% =autorRes("id") %>"><font size="-1" color="#FFCC66" face="arial">Tem coment�rios de autor por moderar</font></a><br>
		<% end if %>
