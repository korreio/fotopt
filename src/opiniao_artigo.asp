...
OpcaoMenu "INSERIR OU MUDAR OPINI�O", "inserir_opiniao.asp?ordem=" & ordem & "&artigo=" & artigo, False, True, -1, False, False
OpcaoMenu "MUDAR OU APAGAR ARTIGO", "adm/adm_mudar_opiniao.asp?ordem=" & ordem & "&artigo=" & artigo, False, False, -1, False, True
Menu 2, 5, "OPINI�ES SOBRE MATERIAL"
%>
...
%>
		<tr valign="top">
			...
			<td>
				<font size="-1" color="#FFCC66" face="arial"><b>OPINI�O:</b></font>&nbsp;&nbsp;
