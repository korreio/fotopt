...
<% if session("login") <> 0 then %>
  <tr>
    <td>
		...
		&nbsp;<font size="-2" color="silver" face="verdana, arial">(inseridas desde a �ltima vez que fez login)</font>
	</td>
  </tr>
<% end if %>
  ...
  <tr>
    <td>
		<font color="white" face="arial"><b>INSERIDAS NO M�S:</b></font>
		<br>
  ...
  <tr>
    <td>
		...
		<tr><td>
			<br><br>
			<a href="procurar_data.asp"><font size="-1" color="#FFCC66" face="arial"><b>BUSCA AVAN�ADA</b></font></a>
			&nbsp;&nbsp;<font size="-2" color="silver" face="arial">(entre duas datas ou at� uma data)</font>
		</td></tr>
		</table>
	</td>
  </tr>
