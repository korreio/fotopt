...
<%
if ordem = "nome" then
	OpcaoMenu "ORDENAR POR CLASSIFICA��O", "opiniao_tipo.asp?ordem=class&tipo=" & tipo, False, False, -1, False, False
else
...
Menu 2, 5, "OPINI�ES SOBRE MATERIAL - " & grupoRes("nome") & " - " & tipoRes("nome")
%>
