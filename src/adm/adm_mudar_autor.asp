...
decodedPassword = Aspas2Quot(DeCifrar(autorRes("en_dadop"), autorRes("data"), autorRes("ip_inscricao")))
%>

<form action="adm_mudar_autor_res.asp?autor=<% =autor %>" method=post>
...
<table border="0" cellpadding="3" cellspacing="0">
	...
	<tr><td><font color="#FFCC66" size="-1" face="arial"><b>NOME NO SITE:</font></td><td><input maxlength="255" value="<% =autorRes("nome") %>" size="40" type="Text" name="nome"></td></tr>
	<tr><td><font color="red" size="-1" face="arial"><b>NOME INSCRI&Ccedil;&Atilde;O:</font></td><td><input maxlength="255" value="<% =autorRes("nome_inscricao") %>" size="40" type="Text" name="nome_inscricao"></td></tr>
	<tr><td><br></td><td></td></tr>	
	<tr><td><font size="-1" color="red" face="arial"><b>LOGIN: </b></font></td><td><input maxlength="255" value="<% =Aspas2Quot(autorRes("dadol")) %>" size="15" type="text" name="login"> <font size="-1" color="white" face="arial">(obrig)</font></td></tr>
	<tr><td><font size="-1" color="#FFCC66" face="arial"><b>PASSWORD: </b></font></td><td><input maxlength="255" value="<% =decodedPassword %>" size="15" type="text" name="password1"> <font size="-1" color="white" face="arial">(obrig)</font></td></tr>
	<tr><td><font size="-1" color="#FFCC66" face="arial"><b>CONFIRMAR<br>PASSWORD: </b></font></td><td><input maxlength="255" value="<% =decodedPassword %>" size="15" type="password" name="password2"> <font size="-1" color="white" face="arial">(obrig)</font></td></tr>
	<tr><td><br></td><td></td></tr>
	...
	<tr>
		<td><font color="red" size="-1" face="arial"><b>JURI:</b></font></td>
		<td>
			<select name="juri">
				<option value="1">Sim</option>
			<% if autorRes("juri") = False then %>
				<option selected value="0">N&atilde;o</option>
			<% else %>
				<option value="0">N&atilde;o</option>
			<% end if %>
			</select><font size="-1" color="white" face="arial"> (obrig)</font>
		</td>
	</tr>
	<tr><td><br></td><td></td></tr>
	...
	<tr><td><font color="#FFCC66" size="-1" face="arial"><b>REGI&Atilde;O DO PA&Iacute;S: </b></font></td><td><input <% if autorRes("regiao") <> "-1" then %>value="<% =autorRes("regiao") %>"<% end if %> maxlength="255" size="40" type="Text" name="regiao"></td></tr>
	<tr>
