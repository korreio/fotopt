...
<table border="0" cellpadding="3" cellspacing="0">
	<tr>
		...
		<td>
			...
			<option <% if destaqueRes("seccao") = 5 then %>selected<% end if %> value="5">Informa��o</option>
			<option <% if destaqueRes("seccao") = 6 then %>selected<% end if %> value="6">Classificados</option>
			<option <% if destaqueRes("seccao") = 7 then %>selected<% end if %> value="7">Opini�o</option>
			<option <% if destaqueRes("seccao") = 8 then %>selected<% end if %> value="8">�teis</option>
			</select>
		</td>
	</tr>
	<tr>
