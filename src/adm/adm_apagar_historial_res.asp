...
<td bgcolor="gray" width="100%" align="left"><font size="-1" color="black" face="arial">&nbsp;APAGAR HISTORIAL</font></td>
<!-- #include file="fim_topo.asp" -->
<!-- #include file="autenticar_webmaster.asp" -->

<%
if apagar = "on" then
	SQL = "DELETE FROM historial WHERE id = " & historial
	dbConnection.Execute(SQL)
%>
	<meta http-equiv="refresh" content="0;url=../historial.asp">
	<font size="+1" color="white" face="arial"><b>Historial apagado com sucesso</b></font>
<% else %>
