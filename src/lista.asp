...
<%
OpcaoMenu "VOLTAR P�GINA ACTUAL", "galeria.asp?tipo=" & tipo & "&primeira=" & primeira & "&id=" & id & "&tema=" & tema, False, False, -1, False, False
...
Menu 1, GaleriaSubSeccao(tipo, id), "P�GINAS DA GALERIA DE " & nomeGaleria
%>
