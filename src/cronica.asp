...
OpcaoMenu "LER OU INSERIR COMENT�RIOS", "comentarios.asp?foto=" & foto & "&primeira=" & primeira & "&tema=" & tema & "&tipo=" & tipo & "&id=" & id & "&num=" & num, False, False, -1, False, False
'OpcaoMenu "ALTERAR OU APAGAR CR�NICA", "inserir_cronica.asp?foto=" & foto & "&primeira=" & primeira & "&tema=" & tema & "&tipo=" & tipo & "&id=" & id & "&num=" & num, False, True, fotoRes("autor"), False, False
Menu 1, GaleriaSubSeccao(tipo, id), "CR�NICA"
%>
...
<td>
	<table border="0" cellpadding="2" cellspacing="0">
		...
		<tr>
			<td>
				<font size="-1" color="#FFCC66" face="arial"><b>CR�NICA: </b></font>
			</td>
			<td valign="bottom">
...
<br>
<font size="-2" color="white" face="arial">Direitos de autor</font><font size="-2" color="white" face="arial">: Os textos s&atilde;o propriedade do autor ou dos seus clientes, podendo ser reproduzida somente com autoriza��o dos mesmos.</font>
