...
<%
OpcaoMenu "VOLTAR � GALERIA", "galeria_evento.asp?primeira=" & primeira & "&evento=" & evento & "&num=" & num, False, False, -1, False, False
OpcaoMenu "VER A FOTO", "foto_evento.asp?foto=" & foto & "&primeira=" & primeira & "&evento=" & evento & "&num=" & num, False, False, -1, False, False
'OpcaoMenu "INSERIR, ALTERAR OU APAGAR COMENT�RIO", "inserir_comentario_evento.asp?foto=" & foto & "&primeira=" & primeira & "&evento=" & evento & "&num=" & num, False, True, -1, False, False
Menu 2, 4, "COMENT�RIOS"
%>
