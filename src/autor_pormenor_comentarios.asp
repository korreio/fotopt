...
<% 
OpcaoMenu "TODA A CONTRIBUI��O DESTE AUTOR", "autor_pormenor.asp?autor=" & autor, False, False, -1, False, False
Menu 3, 2, "CONTRIBUI��O, COMENT�RIOS - " & autorRes("nome")
%>
...
<tr><td>
	...
	<% if not fotoRes.eof then %>
		<tr>
			<td valign="top"><font size="-1" color="#FFCC66" face="arial">&nbsp;&nbsp;<i>AN�NIMOS</i></font>&nbsp;&nbsp;</td>
