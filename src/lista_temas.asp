...
<tr>
	<td width="220" valign="top" height="300">
		...
		<br><font size="-1" color="white" face="arial">Sem respeitar a divis�o por temas do autor.</font>

		<% if numFotoRes("numPreferidas") > 0 then %>
			<br><br>
			<a href="galeria.asp?tipo=preferidas_autor&id=<% =autor %>"><font color="#FFCC66" size="-1" face="arial"><b>A SELEC��O DO PR�PRIO AUTOR</b></font></a>
			<br><font size="-1" color="white" face="arial">Escolhidas pelo autor entre todas as que est�o na sua galeria.</font>
		<% end if %>
		...
		<% if numFotoVencedorasRes("num") > 0 then %>
			...
			<br><font size="-1" color="white" face="arial">Destacadas pelo j�ri ou vencedoras de algum concurso no site.</font>
		<% end if %>
	</td>
</tr>
</table>
